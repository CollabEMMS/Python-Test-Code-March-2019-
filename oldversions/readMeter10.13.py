...
def save(data, name):
    try:
        ...
        print("Data saved")  # Feedback print statement
...
def main():
    ...
    data = [["File Name",name],["Date",date],["Test Info",testInfo],["Directory",filePath],[],["System TIMESTAMP", "EKMPOWER", "EMMS POWER", "EKM Energy Used", "EMMS Energy Used"]]
